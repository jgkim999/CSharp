...
public class UserRepositoryPostgre : IUserRepository
{
    ...
    /// <summary>
    /// Initializes a new instance of the UserRepositoryPostgre class for user data operations using PostgreSQL.
    /// </summary>
    ...
    /// <summary>
    /// Asynchronously creates a new user record in the database with the specified name, email, and SHA-256 hashed password.
    /// </summary>
    /// <param name="name">The user's name.</param>
    /// <param name="email">The user's email address.</param>
    /// <param name="passwordSha256">The user's password, hashed with SHA-256.</param>
    ...
    /// <summary>
    /// Retrieves a list of users from the database, limited to the specified number of results.
    /// </summary>
    /// <param name="limit">The maximum number of users to retrieve (default is 10, maximum is 100).</param>
