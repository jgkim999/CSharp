...
public class UserRepositoryPostgre : IUserRepository
{
    ...
    /// </summary>
    /// <summary>
    /// Asynchronously retrieves up to the specified number of users from the database and returns them as a list of user DTOs.
    /// </summary>
    /// <param name="limit">The maximum number of users to retrieve (maximum allowed is 100).</param>
