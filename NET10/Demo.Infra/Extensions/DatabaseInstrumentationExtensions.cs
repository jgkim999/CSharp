...
public static class DatabaseInstrumentationExtensions
{
    ...
    /// <summary>
    /// Executes a database operation asynchronously with OpenTelemetry instrumentation, logging, and telemetry tagging.
    /// </summary>
    ...
    /// <returns>The result of the database operation.</returns>
    /// <remarks>
    /// This method tracks the operation's duration, logs start and completion events, records errors and exceptions, and attaches relevant metadata as activity tags for observability.
    /// </remarks>
