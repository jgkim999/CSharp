...
public static class DatabaseInstrumentationExtensions
{
    ...
    /// <summary>
    /// Executes a database operation asynchronously with OpenTelemetry instrumentation, capturing operation metadata, performance metrics, and error information.
    /// </summary>
    ...
    /// <param name="dbSystem">The database system identifier (e.g., "postgresql").</param>
    ...
    /// <param name="additionalTags">Optional additional tags to include in the OpenTelemetry activity.</param>
    /// <returns>The result of the database operation.</returns>
    /// <remarks>
    /// This method starts an OpenTelemetry activity, logs operation start and completion, records execution duration, and captures error details if an exception occurs.
    /// </remarks>
