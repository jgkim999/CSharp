...
public static class DatabaseInstrumentationExtensions
{
    ...
    /// <param name="dbSystem">The database system (e.g., "postgresql", "sqlserver").</param>
    ...
    /// <exception cref="Exception">Rethrows any exception encountered during the database operation after recording telemetry and logging.</exception>
