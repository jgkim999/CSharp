...
public static class DatabaseInstrumentationExtensions
{
    ...
    /// <summary>
    /// Executes a database operation asynchronously with OpenTelemetry instrumentation, tracing, and logging.
    /// </summary>
    ...
    /// <returns>The result of the database operation.</returns>
    /// <remarks>
    /// This method starts an OpenTelemetry activity, logs operation lifecycle events, records execution duration, and handles error tagging and logging. Exceptions thrown by the operation are logged, tagged, and rethrown.
    /// </remarks>
