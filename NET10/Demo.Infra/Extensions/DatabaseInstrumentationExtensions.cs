...
public static class DatabaseInstrumentationExtensions
{
    ...
    /// <summary>
    /// Executes a database operation asynchronously with OpenTelemetry instrumentation, capturing operation metadata, execution timing, and error information.
    /// </summary>
    ...
    /// <param name="dbSystem">The type of database system (e.g., "postgresql").</param>
    ...
    /// <param name="repositoryClass">The name of the repository class executing the operation.</param>
    ...
    /// <param name="additionalTags">Optional additional tags to include in the activity for telemetry.</param>
    /// <returns>The result of the database operation.</returns>
