    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <param name="logger">The logger used for recording command execution details.</param>
    ...
    /// <summary>
    /// Handles a command by invoking the inner handler with telemetry tracing, logging, and metrics, and returns the result.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by invoking the inner handler with telemetry tracing, logging, and metrics for execution and errors.
    /// </summary>
