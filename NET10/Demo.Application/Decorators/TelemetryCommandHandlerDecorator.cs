    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TelemetryCommandHandlerDecorator{TCommand, TResult}"/> class, adding telemetry and logging to the specified command handler.
    /// </summary>
    /// <param name="innerHandler">The command handler to decorate.</param>
    /// <param name="logger">The logger used for command processing events.</param>
    /// <param name="telemetryService">The telemetry service for tracing and metrics.</param>
    ...
    /// <summary>
    /// Processes the specified command asynchronously, adding telemetry tracing, logging, and business metrics, and returns the result.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by invoking the inner handler with telemetry tracing, logging, and business metric recording.
    /// </summary>
    /// <param name="command">The command to process.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
