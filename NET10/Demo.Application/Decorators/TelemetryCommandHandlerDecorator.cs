    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <param name="logger">The logger used for command execution logging.</param>
    ...
    /// <summary>
    /// Processes a LiteBus command with telemetry tracing and logging, returning the result produced by the inner command handler.
    /// </summary>
    /// <param name="command">The command to process.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>The result produced by processing the command.</returns>
    /// <remarks>
    /// Adds telemetry activity, logs execution details, records metrics, and propagates exceptions after logging and telemetry updates.
    /// </remarks>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by invoking the inner handler with telemetry tracing, logging, and business metric recording for execution duration and outcome.
    /// </summary>
    /// <param name="command">The command to process.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
