    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TelemetryCommandHandlerDecorator{TCommand, TResult}"/> class, enabling telemetry tracing and logging for command handling.
    /// </summary>
    /// <param name="innerHandler">The command handler to be decorated with telemetry and logging.</param>
    /// <param name="logger">The logger used for recording command processing events.</param>
    /// <param name="telemetryService">The telemetry service used for tracing and metrics.</param>
    ...
    /// <summary>
    /// Processes a LiteBus command with telemetry tracing, logging, and business metric recording.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TelemetryCommandHandlerDecorator{TCommand}"/> class, adding telemetry tracing and logging to the specified command handler.
    /// </summary>
    public TelemetryCommandHandlerDecorator(
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command with integrated telemetry tracing, logging, and business metric recording.
    /// </summary>
    /// <param name="command">The command to process.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <remarks>
    /// Records telemetry activity, logs processing events, and tracks success or error metrics for the command execution. Exceptions are logged, recorded in telemetry, and rethrown.
    /// </remarks>
