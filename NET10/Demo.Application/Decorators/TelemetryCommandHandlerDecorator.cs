    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by executing the inner handler with telemetry tracing, logging, and business metric recording for both success and error scenarios.
    /// </summary>
