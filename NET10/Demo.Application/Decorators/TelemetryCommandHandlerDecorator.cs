    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TelemetryCommandHandlerDecorator{TCommand, TResult}"/> class, enabling telemetry tracing and logging for command handlers.
    /// </summary>
