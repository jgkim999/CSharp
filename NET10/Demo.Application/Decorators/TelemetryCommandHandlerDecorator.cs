    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TelemetryCommandHandlerDecorator{TCommand, TResult}"/> class, enabling telemetry tracing for command handling operations.
    /// </summary>
    /// <param name="innerHandler">The command handler to be decorated with telemetry functionality.</param>
    /// <param name="logger">The logger used for recording command processing events.</param>
    /// <param name="telemetryService">The telemetry service used to track command execution and metrics.</param>
    ...
    /// <summary>
    /// Handles a LiteBus command with telemetry tracing, logging, and business metric recording, returning the command result.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command with telemetry tracing, logging, and business metric recording.
    /// </summary>
    /// <param name="command">The command to process.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <remarks>
    /// Records telemetry activity, logs processing events, and tracks success or error metrics for the command execution. Exceptions are logged, metrics are updated, and the exception is rethrown.
    /// </remarks>
