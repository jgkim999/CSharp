    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Handles a command by invoking the inner handler with telemetry tracing, logging, and business metric recording.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a command by invoking the inner handler and adds telemetry tracing, logging, and business metrics for the command execution.
    /// </summary>
