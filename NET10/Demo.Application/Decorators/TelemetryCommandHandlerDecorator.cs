    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <remarks>
    /// This method records telemetry data and logs information about the command execution, including success and error metrics, execution duration, and trace context.
    /// </remarks>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <remarks>
    /// This method wraps command handling with telemetry activity, logs execution details, and records business metrics for both success and error cases. Exceptions encountered during command processing are logged, telemetry is updated, and the exception is rethrown.
    /// </remarks>
