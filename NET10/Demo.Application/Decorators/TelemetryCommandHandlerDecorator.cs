    ...
    where TCommand : class, ICommand
{
    ...
    /// <remarks>
    /// This method wraps the execution of the inner command handler with telemetry activity, logs processing events, and records success or error metrics. Exceptions are logged, metrics are updated accordingly, and the exception is rethrown.
    /// </remarks>
