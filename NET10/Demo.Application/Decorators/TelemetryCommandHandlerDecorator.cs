    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <param name="telemetryService">The telemetry service used for tracing and recording metrics.</param>
    ...
    /// <summary>
    /// Processes the specified command with telemetry tracing and logging, returning the result produced by the inner command handler.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by invoking the inner handler and recording telemetry and metrics for tracing, performance, and error monitoring.
    /// </summary>
