    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Processes a command with telemetry tracing, logging, and metrics, returning the result from the inner command handler.
    /// </summary>
    /// <param name="command">The command to process.</param>
    /// <param name="cancellationToken">A token to cancel the operation.</param>
    /// <returns>The result produced by processing the command.</returns>
    /// <exception cref="Exception">Rethrows any exception encountered during command processing after recording telemetry and metrics.</exception>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by invoking the inner handler and augmenting execution with telemetry tracing, logging, and business metrics.
    /// </summary>
    /// <param name="command">The command to process.</param>
