    ...
    where TCommand : class, ICommand<TResult>
{
    ...
    /// <summary>
    /// Processes the specified command asynchronously, adding telemetry tracing, logging, and business metrics around the command execution.
    /// </summary>
    ...
    where TCommand : class, ICommand
{
    ...
    /// <param name="command">처리할 명령</param>
    /// <summary>
    /// Handles a LiteBus command by invoking the inner handler and recording telemetry and logging information for tracing, metrics, and error tracking.
    /// </summary>
