...
/// <param name="tags">Optional key-value pairs providing additional context for the activity.</param>
...
/// <param name="duration">The time taken to process the request, in milliseconds.</param>
    ...
    /// <summary>
/// Records an error metric with the specified error type, operation name, and an optional descriptive message.
/// </summary>
...
/// <param name="exception">The exception that caused the failure.</param>
    ...
    /// <summary>
/// Logs an informational message with trace context using the specified logger and message template.
/// </summary>
...
/// <param name="propertyValues">Optional property values to format the message template.</param>
    ...
    /// <param name="messageTemplate">The message template for the log entry.</param>
    /// <summary>
/// Logs an error message with trace context and exception details using the specified logger and message template.
/// </summary>
/// <param name="exception">The exception to include in the log entry.</param>
/// <param name="messageTemplate">The message template for formatting the log entry.</param>
/// <param name="propertyValues">Optional property values to format the message template.</param>
