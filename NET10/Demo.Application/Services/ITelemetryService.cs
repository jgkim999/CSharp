...
public interface ITelemetryService
{
    ...
    /// <summary>
/// Starts a telemetry activity with the specified operation name and optional contextual tags.
/// </summary>
...
/// <param name="endpoint">The endpoint or route accessed.</param>
...
/// </summary>
/// <param name="activity">The telemetry activity to mark as failed.</param>
