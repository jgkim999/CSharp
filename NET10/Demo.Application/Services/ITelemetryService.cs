...
/// <param name="tags">Optional tags providing additional context for the activity.</param>
...
/// <param name="exception">The exception that caused the failure.</param>
    ...
    /// <summary>
/// Logs an informational message with trace context using the specified message template and property values.
/// </summary>
