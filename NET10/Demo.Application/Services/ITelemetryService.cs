...
public interface ITelemetryService
{
    ...
    /// <summary>
/// Starts a custom telemetry activity with the specified operation name and optional tags.
/// </summary>
/// <param name="operationName">The name of the operation for the activity.</param>
/// <param name="tags">Optional key-value pairs to associate with the activity.</param>
/// <returns>The started <see cref="Activity"/> instance, or null if the activity could not be started.</returns>
    ...
    /// <summary>
/// Records metrics for an HTTP request, including method, endpoint, status code, and processing duration.
/// </summary>
...
/// <param name="message">An optional message providing additional details about the error.</param>
...
/// <param name="tags">Optional tags providing additional context for the metric.</param>
    void RecordBusinessMetric(string metricName, long value, Dictionary<string, object?>? tags = null);

    /// <summary>
/// Marks the specified activity as successful, optionally including a message.
/// </summary>
...
void SetActivitySuccess(Activity? activity, string? message = null);
    /// <summary>
/// Marks the specified activity as failed and associates it with the provided exception.
/// </summary>
/// <param name="activity">The activity to mark as errored.</param>
...
void LogWarningWithTrace(ILogger logger, string messageTemplate, params object[] propertyValues);
    /// <summary>
/// Logs an error message with tracing context and an associated exception using the provided logger.
/// </summary>
