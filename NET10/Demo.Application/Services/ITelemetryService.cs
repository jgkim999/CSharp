...
/// <param name="tags">Optional contextual tags to associate with the activity.</param>
...
/// <param name="duration">The time taken to process the request, in milliseconds.</param>
    ...
    /// <summary>
/// Records an error metric with the specified error type, operation, and an optional descriptive message.
/// </summary>
