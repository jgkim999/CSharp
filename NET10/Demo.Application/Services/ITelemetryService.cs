...
/// <param name="message">An optional descriptive message about the error.</param>
    ...
    /// <summary>
/// Records a business-related metric with the specified name, value, and optional tags for telemetry purposes.
/// </summary>
...
/// <param name="tags">Optional key-value pairs providing additional context for the metric.</param>
    ...
    /// <summary>
/// Marks the specified activity as successful, optionally attaching a message.
/// </summary>
...
void LogWarningWithTrace(ILogger logger, string messageTemplate, params object[] propertyValues);
    /// <summary>
/// Logs an error message with trace context and an associated exception using the provided logger.
/// </summary>
