...
public interface ITelemetryService
{
    ...
    /// <summary>
/// Starts a telemetry activity with the specified operation name and optional tags for distributed tracing.
/// </summary>
...
/// </summary>
/// <param name="errorType">A string identifying the type or category of the error.</param>
...
/// </summary>
/// <param name="activity">The telemetry activity to mark as failed. If null, no action is taken.</param>
