...
/// <param name="duration">The time taken to process the request, in milliseconds.</param>
    ...
    /// <summary>
/// Records an error metric for a specified error type and operation, with an optional error message.
/// </summary>
...
/// <param name="message">An optional descriptive error message.</param>
...
void SetActivityError(Activity? activity, Exception exception);
    /// <summary>
/// Logs an informational message with trace context using the specified logger.
/// </summary>
...
void LogWarningWithTrace(ILogger logger, string messageTemplate, params object[] propertyValues);
    /// <summary>
/// Logs an error message with trace context and exception details using the provided logger.
/// </summary>
