...
/// <param name="duration">The time taken to process the request, in milliseconds.</param>
    ...
    /// <summary>
/// Records an error metric with the specified error type and operation, optionally including a descriptive message.
/// </summary>
...
/// </summary>
/// <param name="activity">The telemetry activity to mark as successful.</param>
