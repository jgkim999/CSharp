...
/// <param name="tags">Optional contextual tags to include with the activity.</param>
...
/// <param name="duration">The time taken to process the request, in milliseconds.</param>
    ...
    /// <summary>
/// Records an error metric for a specified operation and error type, with an optional descriptive message.
/// </summary>
