...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Marks the specified activity as failed due to an exception, setting error-related tags and adding an exception event.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message at the specified level, including current trace context properties if an activity is active.
    /// </summary>
    ...
    /// <returns>An <see cref="IDisposable"/> that manages the lifetime of the log context properties.</returns>
