...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Marks the specified activity as failed due to an exception, setting error status, tags, and recording the exception as an activity event.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message at the specified level, including current trace context properties if an activity is present.
    /// </summary>
