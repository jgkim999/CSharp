...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Marks the specified activity as failed due to an exception, setting error status and tags, and adds an exception event with detailed exception information.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message including the current activity's trace context, if available.
    /// </summary>
