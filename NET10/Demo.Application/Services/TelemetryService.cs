...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a business-specific metric with the given name and value, optionally including custom tags.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message at the specified level, enriching the log context with the current activity's trace identifiers and operation name.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an information-level message, enriching the log entry with the current trace context if available.
    /// </summary>
    /// <param name="messageTemplate">The message template for the log entry.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message with the current trace context, including trace identifiers and operation name if available.
    /// </summary>
    /// <param name="messageTemplate">The message template for the warning log.</param>
    /// <param name="propertyValues">Values to format into the message template.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an error message with exception details, enriching the log context with current trace identifiers if an activity is present.
    /// </summary>
    ...
    /// <summary>
    /// Creates a structured logging context that includes current trace identifiers and user-defined properties.
    /// </summary>
    /// <param name="properties">A dictionary of additional properties to include in the log context.</param>
    /// <returns>
    /// An <see cref="IDisposable"/> that manages the lifetime of the pushed log context properties.
    /// </returns>
