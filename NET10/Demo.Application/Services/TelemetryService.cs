...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Logs a message at the specified level, including current activity trace context properties in the log.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an informational message including the current activity's trace context, if available.
    /// </summary>
    ...
    /// <summary>
    /// Creates a log context that includes current activity trace information and additional user-defined properties.
    /// </summary>
    /// <param name="properties">A dictionary of properties to include in the log context.</param>
