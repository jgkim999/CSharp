...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a custom business metric with the specified name and value, optionally including additional tags.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message at the specified level, enriching the log entry with the current activity's trace context properties.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an informational message enriched with the current trace context, if available.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message enriched with the current trace context, if available.
    /// </summary>
    /// <param name="messageTemplate">The message template for the log entry.</param>
    /// <param name="propertyValues">Values to format into the message template.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an error message with exception details, enriching the log with current trace context if available.
    /// </summary>
    ...
    /// <summary>
    /// Creates a structured logging context that includes the current trace information and additional user-defined properties.
    /// </summary>
    /// <param name="properties">A dictionary of custom properties to include in the log context.</param>
    /// <returns>An <see cref="IDisposable"/> that manages the lifetime of the log context.</returns>
