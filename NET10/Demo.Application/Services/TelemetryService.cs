...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a business-specific metric by incrementing a named counter with the specified value and optional tags.
    /// </summary>
    ...
    /// <summary>
    /// Marks the specified activity as failed due to an exception, setting error status and tags, and adds an exception event with details.
    /// </summary>
    ...
    /// <param name="activity">Activity 객체</param>
    /// <summary>
    /// Marks the specified activity as successful, setting its status to OK and adding an optional success message.
    /// </summary>
    /// <param name="activity">The activity to update.</param>
    /// <param name="message">An optional success message to associate with the activity.</param>
    ...
    /// <summary>
    /// Logs a message at the specified level, including the current activity's trace context properties.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an informational message with the current activity's trace context included.
    /// </summary>
    /// <param name="logger">The logger to write the message to.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message with the current activity's trace context included, if available.
    /// </summary>
    ...
    /// <param name="propertyValues">Optional property values to format into the message template.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an error message with exception details and includes trace context properties if an activity is present.
    /// </summary>
    ...
    /// <summary>
    /// Creates a log context that includes the current activity's trace information and additional user-defined properties.
    /// </summary>
    /// <param name="properties">A dictionary of custom properties to include in the log context.</param>
    /// <returns>An <see cref="IDisposable"/> that manages the lifetime of the pushed log context properties.</returns>
