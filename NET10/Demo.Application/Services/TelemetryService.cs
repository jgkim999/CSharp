...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Logs a message at the specified level, enriching the log entry with the current trace context properties if an activity is present.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an informational message enriched with the current trace context, including trace and span identifiers.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message enriched with the current trace context, including trace and span identifiers if available.
    /// </summary>
    ...
    /// <param name="messageTemplate">The message template for the log entry.</param>
    /// <param name="propertyValues">Optional values to format the message template.</param>
