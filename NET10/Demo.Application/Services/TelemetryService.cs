...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a business-specific metric with the given name, value, and optional tags.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message at the specified level, including the current activity's trace context as structured log properties.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an information-level message including the current activity's trace context, if available.
    /// </summary>
    /// <param name="logger">The logger to write the message to.</param>
    /// <param name="messageTemplate">The message template for the log entry.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning-level message including the current activity's trace context, if available.
    /// </summary>
    /// <param name="messageTemplate">The message template for the log entry.</param>
    /// <param name="propertyValues">Values to format into the message template.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an error-level message with exception details and includes trace context properties if an activity is present.
    /// </summary>
