...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a custom business metric with the specified name, value, and optional tags.
    /// </summary>
    ...
    /// <param name="tags">Optional key-value pairs to associate as tags with the metric.</param>
    ...
    /// <summary>
    /// Marks the specified activity as failed due to an exception and attaches error details as tags and an event.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message with the current activity's trace context properties included in the log context.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message with the current trace context, if available.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an error message and exception, including trace context properties if an activity is present.
    /// </summary>
    ...
    /// </summary>
    /// <param name="properties">A dictionary of custom properties to include in the logging context.</param>
    /// <returns>An <see cref="IDisposable"/> that manages the lifecycle of the pushed log context properties.</returns>
