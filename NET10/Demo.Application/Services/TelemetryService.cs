...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a business-specific metric with the given name and value, optionally associating tags.
    /// </summary>
    ...
    /// <summary>
    /// Marks the specified activity as failed due to an exception and attaches relevant error details as tags and an event.
    /// </summary>
    ...
    /// <summary>
    /// Logs a message at the specified level, including the current activity's trace context properties in the log.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message, including the current trace context if available.
    /// </summary>
    ...
    /// <returns>An <see cref="IDisposable"/> that manages the lifetime of the logging context.</returns>
