...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Logs a message with the current activity's trace context properties included in the Serilog log context.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an informational message with the current activity's trace context included in the log properties, if available.
    /// </summary>
    /// <param name="logger">The logger to write the message to.</param>
    /// <param name="messageTemplate">The message template for the log entry.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs a warning message with the current activity's trace context included in the log properties, if available.
    /// </summary>
    ...
    /// <returns>An <see cref="IDisposable"/> that, when disposed, removes all pushed log context properties.</returns>
