...
public sealed class TelemetryService : ITelemetryService, IDisposable
{
    ...
    /// <summary>
    /// Records a business-specific metric, creating a counter for the metric name if it does not already exist.
    /// </summary>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an information-level message enriched with the current activity's trace context.
    /// </summary>
    /// <param name="messageTemplate">The message template for the log entry.</param>
    /// <param name="propertyValues">Values to format into the message template.</param>
    ...
    /// <param name="messageTemplate">메시지 템플릿</param>
    /// <summary>
    /// Logs an error message with exception details, enriching the log context with current activity trace information if available.
    /// </summary>
