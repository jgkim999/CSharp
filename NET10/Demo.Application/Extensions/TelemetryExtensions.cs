...
public static class TelemetryExtensions
{
    ...
    /// </summary>
    /// <summary>
    /// Creates a telemetry decorator instance that wraps the specified command handler.
    /// </summary>
    ...
    /// <returns>An instance of the decorator type wrapping the resolved command handler.</returns>
