...
public static class TelemetryExtensions
{
    ...
    /// </summary>
    /// <summary>
    /// Creates an instance of the specified telemetry decorator, injecting the inner command handler, a logger, and an ITelemetryService.
    /// </summary>
    ...
    /// <returns>An instance of the decorator type wrapping the specified inner handler.</returns>
