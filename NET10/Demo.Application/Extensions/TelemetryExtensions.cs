...
public static class TelemetryExtensions
{
    ...
    /// </summary>
    /// <summary>
    /// Creates an instance of the specified telemetry decorator type, injecting the resolved inner handler, a logger for the decorator, and an ITelemetryService.
    /// </summary>
    ...
    /// <returns>An instance of the decorator type wrapping the resolved inner handler.</returns>
