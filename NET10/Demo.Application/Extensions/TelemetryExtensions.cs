...
public static class TelemetryExtensions
{
    ...
    /// <summary>
    /// Adds telemetry support to LiteBus command handlers by decorating them with telemetry decorators in the service collection.
    /// </summary>
    ...
    /// <summary>
    /// Creates an instance of a telemetry decorator for a command handler, injecting the original handler, a logger, and the telemetry service.
    /// </summary>
    /// <param name="provider">The service provider used to resolve dependencies.</param>
    /// <param name="decoratorType">The type of the telemetry decorator to instantiate.</param>
    /// <param name="innerHandlerType">The type of the original command handler to be decorated.</param>
    /// <returns>An instance of the specified telemetry decorator wrapping the original handler.</returns>
