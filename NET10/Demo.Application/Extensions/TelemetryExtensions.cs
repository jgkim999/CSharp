...
public static class TelemetryExtensions
{
    ...
    /// <summary>
    /// Adds telemetry support to all registered LiteBus command handlers by decorating them with telemetry decorators.
    /// </summary>
    /// <returns>The modified service collection with telemetry-enabled command handlers.</returns>
    ...
    /// <param name="innerHandlerType">The type of the inner command handler to be decorated.</param>
