...
public static class TelemetryExtensions
{
    ...
    /// </summary>
    /// <summary>
    /// Creates an instance of the specified telemetry decorator type, injecting the resolved inner handler, a logger, and an ITelemetryService.
    /// </summary>
    ...
    /// <returns>An instance of the decorator type wrapping the inner handler.</returns>
