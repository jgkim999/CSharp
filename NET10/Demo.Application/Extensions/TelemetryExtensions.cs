...
public static class TelemetryExtensions
{
    ...
    /// </summary>
    /// <summary>
    /// Instantiates a telemetry decorator for a command handler, resolving required dependencies from the service provider.
    /// </summary>
    /// <param name="provider">The service provider used to resolve dependencies.</param>
    /// <param name="decoratorType">The type of the telemetry decorator to create.</param>
    /// <param name="innerHandlerType">The type of the command handler to be wrapped by the decorator.</param>
