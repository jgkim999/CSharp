...
public static class TelemetryExtensions
{
    ...
    /// </summary>
    /// <returns>The modified service collection with telemetry decorators applied to command handlers.</returns>
    ...
    /// <summary>
    /// Creates an instance of a telemetry decorator for a command handler, resolving required dependencies from the service provider.
    /// </summary>
    /// <param name="provider">The service provider used to resolve dependencies.</param>
    /// <param name="decoratorType">The type of the telemetry decorator to instantiate.</param>
    /// <param name="innerHandlerType">The type of the original command handler to be wrapped.</param>
    /// <returns>An instance of the specified telemetry decorator wrapping the original command handler.</returns>
