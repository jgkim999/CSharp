...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle anonymous GET requests at "/api/test/logging" for testing logging and tracing integration.
    /// </summary>
    ...
    /// </summary>
    /// <summary>
    /// Handles a test HTTP GET request to demonstrate logging and telemetry integration, including nested activities and error logging.
    /// </summary>
