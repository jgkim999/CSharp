...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle GET requests at /api/test/logging for logging and tracing tests.
    /// </summary>
    ...
    /// </summary>
    /// <summary>
    /// Handles a GET request to test logging and telemetry integration, generating logs at various levels and simulating an exception for tracing.
    /// </summary>
    /// <param name="ct">Token to observe while waiting for the task to complete.</param>
    /// <returns>A task representing the asynchronous operation, with the response containing a completion message, trace information, and timestamp.</returns>
