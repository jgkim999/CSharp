...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Handles the HTTP GET request for the logging test endpoint, demonstrating logging at various levels, nested telemetry activities, and error reporting integrated with tracing.
    /// </summary>
