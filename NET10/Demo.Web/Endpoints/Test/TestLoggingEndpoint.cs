...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle HTTP GET requests at "/api/test/logging" for testing logging and tracing integration.
    /// </summary>
    ...
    /// <returns>A task representing the asynchronous operation. The HTTP response contains a completion message, trace ID, span ID, and timestamp.</returns>
