...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle HTTP GET requests at "/api/test/logging" for logging and tracing integration testing.
    /// </summary>
    ...
    /// </summary>
    /// <summary>
    /// Handles an HTTP GET request to test logging and telemetry integration, including nested telemetry activities and error simulation.
    /// </summary>
