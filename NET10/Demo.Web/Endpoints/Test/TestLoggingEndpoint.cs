...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle GET requests at "/api/test/logging" for logging and tracing integration testing.
    /// </summary>
    ...
    /// </summary>
    /// <summary>
    /// Handles an HTTP GET request to test logging and telemetry integration, including activity tracing, nested operations, and error simulation.
    /// </summary>
