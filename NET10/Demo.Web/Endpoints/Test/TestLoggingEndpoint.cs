...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle anonymous HTTP GET requests at "/api/test/logging" for logging and tracing tests.
    /// </summary>
    ...
    /// </summary>
    /// <summary>
    /// Handles a GET request to test logging and telemetry integration, including activity tracing, nested operations, and error simulation.
    /// </summary>
    /// <param name="ct">A cancellation token that can be used to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation. The HTTP response includes a completion message, trace and span IDs, and a timestamp.</returns>
