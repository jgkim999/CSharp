...
public class TestLoggingEndpoint : EndpointWithoutRequest
{
    ...
    /// <summary>
    /// Configures the endpoint to handle GET requests at /api/test/logging for testing logging and telemetry integration.
    /// </summary>
    ...
    /// </summary>
    /// <summary>
    /// Handles a GET request to test logging and telemetry integration, including nested activities and error simulation.
    /// </summary>
    /// <param name="ct">A cancellation token that can be used to cancel the operation.</param>
    /// <returns>A task representing the asynchronous operation. The HTTP response contains a completion message, trace and span IDs, and a timestamp.</returns>
