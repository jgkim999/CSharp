...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Configures tracing instrumentation, enrichment, sampling, and exporters for OpenTelemetry tracing.
    /// </summary>
    ...
    /// </summary>
    /// <param name="config">The OpenTelemetry configuration specifying exporter type, endpoints, protocols, and headers.</param>
