...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Configures tracing instrumentation and exporters for OpenTelemetry, including ASP.NET Core, HTTP client, and database tracing, as well as custom activity sources and environment-based sampling.
    /// </summary>
    ...
    /// <param name="serviceName">The name of the service to use for custom activity sources.</param>
