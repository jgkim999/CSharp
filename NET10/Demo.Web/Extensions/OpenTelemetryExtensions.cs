...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Registers and configures OpenTelemetry tracing and metrics services in the dependency injection container.
    /// </summary>
    /// <param name="configuration">The application configuration containing OpenTelemetry settings.</param>
    /// <param name="serviceInstanceId">A unique identifier for the service instance.</param>
    ...
    /// <summary>
    /// Configures OpenTelemetry tracing instrumentation, enrichment, sampling, and exporters for the application.
    /// </summary>
    ...
    /// </summary>
    /// <param name="metricsBuilder">The metrics builder used to configure metrics instrumentation and exporters.</param>
    /// <param name="config">The OpenTelemetry configuration settings.</param>
    ...
    /// <summary>
    /// Adds and configures tracing exporters to the TracerProviderBuilder based on the specified OpenTelemetry configuration and environment.
    /// </summary>
