...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Registers and configures OpenTelemetry tracing and metrics services in the dependency injection container using settings from the provided configuration.
    /// </summary>
    ...
    /// <summary>
    /// Configures tracing instrumentation and exporters for OpenTelemetry, including ASP.NET Core, HTTP client, and database tracing, enrichment of telemetry data, sampling strategy, resource attributes, and exporter setup.
    /// </summary>
    ...
    /// <summary>
    /// Configures OpenTelemetry metrics instrumentation and exporters for the application.
    /// </summary>
    /// <param name="metricsBuilder">The metrics builder used to configure instrumentation and exporters.</param>
    /// <param name="config">The OpenTelemetry configuration settings.</param>
    /// <param name="meterName">The name of the custom meter to register for application-specific metrics.</param>
    ...
    /// <summary>
    /// Adds and configures tracing exporters to the provided <see cref="TracerProviderBuilder"/> based on the specified OpenTelemetry configuration and current environment.
    /// </summary>
    ...
    /// <returns>The tracing builder with exporters configured.</returns>
