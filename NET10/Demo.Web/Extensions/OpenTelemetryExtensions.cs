...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Configures OpenTelemetry tracing instrumentation, enrichment, filtering, and exporters for the application.
    /// </summary>
    /// <param name="tracingBuilder">The builder used to configure tracing providers and instrumentation.</param>
    /// <param name="config">The OpenTelemetry configuration settings.</param>
    /// <param name="serviceName">The name of the service for custom ActivitySource registration.</param>
    ...
    /// <param name="config">The OpenTelemetry configuration settings.</param>
    /// <summary>
    /// Configures OpenTelemetry metrics instrumentation, custom meters, histogram views, and OTLP exporter for the application.
    /// </summary>
    /// <param name="metricsBuilder">The builder used to configure OpenTelemetry metrics.</param>
    /// <param name="config">The OpenTelemetry configuration settings.</param>
