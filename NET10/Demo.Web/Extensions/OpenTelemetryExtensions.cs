...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Adds and configures trace exporters to the provided <see cref="TracerProviderBuilder"/> based on the specified OpenTelemetry configuration and current environment.
    /// </summary>
    /// <param name="tracingBuilder">The tracer provider builder to configure.</param>
