...
public static class OpenTelemetryExtensions
{
    ...
    /// <summary>
    /// Configures tracing instrumentation and exporters for OpenTelemetry, including ASP.NET Core, HTTP client, and database tracing, custom activity sources, environment-based sampling, and resource attributes.
    /// </summary>
